    ...
    <div style={{ display: "flex" }}>
        <div style={{ flex: "1", paddingRight: "20px" }}>
            <div style={{ width: "100%", height: "100%", position: "relative" }}>
                <img
                    ...
                    style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "left", paddingLeft:"-20px" }}
                />
            </div>
        </div>
        <div style={{ flex: "1", paddingLeft: "20px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <Button style={{ marginLeft: "auto" }}>Add to cart <ShoppingCartOutlined style={{ verticalAlign: "middle" }} /> </Button>
            </div>
        </div>
    </div>
</Modal>
