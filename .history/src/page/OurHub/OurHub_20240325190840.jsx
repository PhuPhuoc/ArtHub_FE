...
const OurHub = () => {
  ...
  const handleOpenProfile = () => {
    if (modalContent.user && modalContent.user._id) {
      ...
      // Push the UserProfile route to history and pass userId as a parameter
      history.push(`/user-profile/${userId}`); // Adjust the route path according to your routing configuration
    }
  };
