  ...
  <Row>
    ...
    <Col span={12} style={{ paddingLeft: "20px" }}>
      ...
      <Avatar
        ...
        <Button style={{position: 'absolute',right: "150px", alignItems: 'center', border: 'none', outline: 'none'}} onClick={handleHeartClick}>{heartFilled ? <HeartFilled style={{color: 'red'}} /> : <HeartOutlined style={{color: 'red'}} />}</Button>
