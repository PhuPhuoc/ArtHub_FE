...
const OurHub = () => {
  ...
  const handleCreatorClick = (userId) => {
    // Vous pouvez ici définir ce que vous voulez faire lorsque l'utilisateur clique sur le créateur
    // Par exemple, rediriger vers le profil du créateur ou afficher des informations supplémentaires sur le créateur.
    console.log("Clicked on creator:", userId);
  };
                          ...
                          <Meta
                            ...
                            avatar={
                              <Avatar
                                ...
                                onClick={() => handleCreatorClick(item.user[0]._id)} // Ajouter ce gestionnaire d'événements onClick sur la photo de profil (Avatar)
                              />
                            }
                            title={
                              <p
                                style={{
                                  ...
                                  cursor: "pointer" // Ajouter cette ligne pour indiquer que le texte est cliquable
                                }}
                                onClick={() => handleCreatorClick(item.user[0]._id)} // Ajouter ce gestionnaire d'événements onClick sur le nom du créateur (p)
                              >
                                {item.title}
                              </span>
                            }
