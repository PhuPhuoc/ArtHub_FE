  ...
  <Row>
    ...
    <Col span={12} style={{ paddingLeft: "20px" }}>
      ...
      <Avatar
        ...
        <button style={{position: 'absolute', right: "180px",bottom:"45px", size:"2" alignItems: 'center', border: 'none', outline: 'none', transition: 'none', boxShadow:'none'}} onClick={handleHeartClick}>
