...
const OurHub = () => {
  ...
  const [heart, setHeart] = useState(<HeartOutlined style={{color: 'red'}}/>);

  const handleHeartClick = () => {
    setHeart(
      heart === <HeartOutlined style={{color: 'red'}} /> ? <HeartFilled style={{color: 'red'}} /> : <HeartOutlined style={{color: 'red'}} />
    );
  };  
    ...
    <Col span={12} style={{ paddingLeft: "20px" }}>
      ...
      <Avatar
        ...
        <p style={{paddingLeft:"10px", marginTop:"10px", fontSize:"120%"}}>Jean Paul</p>
          <Button style={{position: 'absolute',right: "150px", alignItems: 'center', border: 'none', outline: 'none'}} onClick={handleHeartClick} >{heart}</Button>
