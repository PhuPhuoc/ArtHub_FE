    ...
    <Col span={12} style={{ paddingLeft: "20px" }}>
      ...
      <Avatar
        ...
        <p style={{paddingLeft:"10px", marginTop:"10px", fontSize:"120%"}}>Jean Paul</p>
          <Button style={{position: 'absolute',right: "150px", alignItems: 'center', border: 'none', outline: 'none',         textDecoration: clicked ? 'none' : 'underline'
}} onClick={handleHeartClick} > {heart} </Button>
